    ...
    addProfile(hint, profile) {
        if (profile) {
            ...
            this.chain.providers.push(() => {
                ...
                return new aws_sdk_1.default.SharedIniFileCredentials(params);
            });
            this.chain.providers.push(() => {
                this.hint = `from config sso profile: ${hint} (${profile})`;
                return new SsoCredentials_1.default(params);
            });
            this.chain.providers.push(() => {
                this.hint = `from config credential process profile: ${hint} (${profile})`;
                return new aws_sdk_1.default.ProcessCredentials(params);
            });
        }
    }
}
